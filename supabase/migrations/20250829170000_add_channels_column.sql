-- Add channels column to master table to store exact channel values from CSV
ALTER TABLE public.master ADD COLUMN channels TEXT;

-- Update the process_raw_upload_to_master function to include channels mapping
