...
DROP POLICY IF EXISTS "Public can manage message templates" ON public.message_templates;
DROP POLICY IF EXISTS "Public can manage messages" ON public.messages;
